...
public class ServerConfiguration {
    ...
    public static final String BAGGAGE_HTML_FILE_PATH = "src/main/resources/html/baggagesInfo.html";
    public static final String AIRPORTS_CRON_SCHEDULE_EXPRESSION = "0 0 12 * * ?";
    public static final String BAGGAGE_SCHEDULE_CRON_EXPRESSION = "0 0 12 5 * ?";
